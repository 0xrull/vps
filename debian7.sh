...
wget -O speedtest "https://raw.githubusercontent.com/gidhanbagus/scriptdebian/master/speedtest.sh"
...
wget -O limit.sh "https://raw.githubusercontent.com/gidhanbagus/scriptdebian/master/conf/limit.sh"
curl https://raw.githubusercontent.com/gidhanbagus/scriptdebian/master/conf/user-limit.sh > user-limit.sh
...
echo "gusur : untuk menggusur user yang masa aktifnya sudah habis"  | tee -a log-install.txt
echo "./user-limit.sh 1 : untuk membatasi user yang login pada ssh"  | tee -a log-install.txt
echo "--------------------------------------"  | tee -a log-install.txt

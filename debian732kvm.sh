...
# Banner SSH
echo "Selamat Datang Di Server SSH SGDO Premium" >> /etc/pesan
echo "Powered By : Gidhan Bagus Algary" >> /etc/pesan
...
echo "userlimit <$>: untuk membatasi user yang login pada ssh | cth : userlimit 1"  | tee -a log-install.txt
echo "--------------------------------------"  | tee -a log-install.txt
